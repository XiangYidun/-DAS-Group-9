...
However, "df_extreme" is empty, indicating that there are no samples with predicted probabilities exactly equal to 0 or 1 â€? they are merely close to 0 or 1. Therefore, no adjustment is necessary.
